...
class RegistarDoctor extends StatefulWidget {
  const RegistarDoctor({Key? key}) : super(key: key);

  @override
  State<RegistarDoctor> createState() => _RegistarDoctor();
}

class _RegistarDoctor extends State<RegistarDoctor> {
